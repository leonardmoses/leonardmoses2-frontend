      ...
      <div className="MainContent">
        ...
        <div className={styles.Wallmount}>
          ...
          <div className={styles.WallmountWriteUp}>
            <p>
              Meet Magneto, my primary desktop computer. It is computer with all
              its parts wall-mounted onto a frame. To me, this piece of
            ...
            <p>
              ...
              graphics card externally using a thunderbolt cable (Thunderbolt 1
              at the time). The main problem with that was thunderbolt speeds
              were much slower than the new graphics card could provide, only
              giving 30-50% of the performance.
            </p>
            <p>
              The second solution, which would give me 100% of the performance,
              was to simply use a PC instead. This includes buying PC parts,
              installing windows, and using windows as my primary operating
              system. However, this was not an option for me as I wanted to
              still use macOS.{" "}
            </p>

            <p>
              The third solution was inspired from a question I had. Apple made
              it possible to install windows on mac so why not the opposite,
              installing mac on windows. After all, they both used intel
              processors. I discovered it was possible! Some people call it
              hackintoshing and it allows you to install macOS on PC parts.{" "}
            </p>
            ...
            <p>
              ...
              the wiring and created raised transparent platforms out of acrylic
              sheets. I ordered all the computer parts and wiring necessary. I
              also ran some LED lighting behind the clear acrylic sheets for
              mood lighting.{" "}
            </p>
            ...
            <p>
              ...
              few thousand dollars into these parts as well as the time it took
              to build it. I reminded myself that I am a problem solver and have
              always been able to figure out a solution to every challenge. I
              continued on for days learning and researching what I needed to
              and after many failed attempted, I finally saw the apple logo boot
              up and I managed to install macOS! Not only could I install macOS
              but I could also install Windows and Linux each on separate
              drives. It was an incredible victory and there was no going back
              after that!
            </p>
          </div>
        </div>
